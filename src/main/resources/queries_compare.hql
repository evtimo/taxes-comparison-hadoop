...
$    QUERY_COMPARE_CORRECT_COMPLETELY    $
CREATE TABLE IF NOT EXISTS correct_completely AS
SELECT s.seller_inn_corr AS seller_inn_corr_t,
       s.seller_kpp_corr AS seller_kpp_corr_t,
       s.customer_inn_corr AS customer_inn_corr_t,
       s.customer_kpp_corr AS customer_kpp_corr_t,
       s.total_with_tax_corr AS total_with_tax_corr_t,
       s.total_without_tax_corr AS total_without_tax_corr_t
...
$    QUERY_COMPARE_CORRECT_TOTAL_DIFF    $
...
$    QUERY_COMPARE_SELLER_ERROR_SELLER_HAS_PAIR    $
...
$QUERY_COMPARE_CUSTOMER_ERROR_SELLER_HAS_PAIR$
...
$    QUERY_COMPARE_SELLER_ERROR_CUSTOMER_HAS_PAIR    $  # NOT WORKING CLEARLY
...
$    QUERY_COMPARE_CUSTOMER_ERROR_CUSTOMER_HAS_PAIR    $  # NOT WORKING CLEARLY
